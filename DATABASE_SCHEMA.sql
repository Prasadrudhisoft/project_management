...
CREATE TABLE IF NOT EXISTS attendance (
    ...
    -- Status: present, half_day, on_leave, absent, holiday, weekend
...
CREATE TABLE IF NOT EXISTS attendance_config (
    ...
    half_day_late_after_minutes INT NOT NULL DEFAULT 120,   -- late by 2hrs = half day
    half_day_early_before_minutes INT NOT NULL DEFAULT 120, -- left 2hrs early = half day
    created_at                  DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at                  DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY uq_org (organization_id)
);
